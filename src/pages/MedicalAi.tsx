  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      sender: 'ai',
      content: 'Upload an image of your medical concern or start a symptom chat.',
          ...
          <Card className="bg-white h-[600px] flex flex-col">
            <CardHeader className="flex flex-row justify-between items-center">
              ...
              >
                ...
                <span>{mode === 'image' ? 'Switch to Chat' : 'Switch to Image'}</span>
              </Button>
            </CardHeader>
            ...
            <CardContent className="flex-1 overflow-y-auto p-4 space-y-4">
              {mode === 'image' ? (
                ...
                <SymptomChatbot 
                  ...
                  onNewMessage={(newMessage) => setMessages([...messages, newMessage])}
                />
              )}
            </CardContent>
          </Card>
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-yellow-50">
            <CardContent className="p-4">
              ...
              <p className="text-sm">
                This is an AI assistant. Always consult a professional healthcare provider for accurate diagnosis.
              </p>
            </CardContent>
          </Card>
        </div>
